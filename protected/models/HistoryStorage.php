...
/**
 * This is the model class for table "history_storage".
 *
 * The followings are the available columns in table 'history_storage':
 * @property integer $id
 ...
 */
class HistoryStorage extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return HistoryStorage the static model class
	 */
